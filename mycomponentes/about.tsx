            ...
            <section id="about" className="py-16 bg-gray-800 bg-opacity-50 relative z-10">
                <div className="container mx-auto px-4">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <p className="text-lg text-gray-900 mb-6 leading-relaxed transition-all duration-1000 ease-in-out transform translate-y-10 opacity-0"
                           style={{ transform: isVisible ? 'translateY(0)' : 'translateY(2rem)', opacity: isVisible ? 1 : 0 }}>
                            I'm a passionate React Native and Next.js developer with 2 years of experience building
